<template>
  <div>
    ...
    <div>
      <ul class="collection">
       <li v-for="task in tasks" v-if="!task.is_done" :id="row_task" :key="task.id">
    ...
    <div id="finished-tasks" class="display_none">
      <ul class="collection">
        <li v-for="task in tasks" v-if="task.is_done"v-bind:id="'row_task_' + task.id" class="collection-item" :key="task.id">
